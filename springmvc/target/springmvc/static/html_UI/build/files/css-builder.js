jQuery(function ($) {
    ...
    $('#btn-build-css').on('click', function () {
        ...
        //compile Main file
        renderLess({
            less_input: ace_less, name: 'ace', less_vars: updateVars, ie_fix: true, callback: function () {
                ...
                //compile Bootstrap
                renderLess({
                    less_input: ' @import "../assets/css/less/bootstrap/bootstrap.less"; ',
                    name: 'bootstrap',
                    less_vars: gridVars,
                    callback: function () {
                        ...
                        if (updateVars['enable-skin-file'] === 'true') {
                            renderLess({
                                less_input: ' @import "../assets/css/less/skins/skins.less"; ',
                                name: 'ace-skins',
                                less_vars: updateVars,
                                callback: function () {

                                    if (updateVars['enable-rtl-file'] === 'true') {
                                        renderRTL({
                                            less_input: ' @import "../assets/css/less/ace-rtl.less"; ',
                                            name: 'ace-rtl',
                                            less_vars: updateVars
                                        }, function () {
                                            showModal()

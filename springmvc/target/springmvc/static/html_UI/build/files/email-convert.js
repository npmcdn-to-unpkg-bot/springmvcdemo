            ...
            if (child.nodeType == 1 && child.getAttribute('data-uid') == null) {
                ...
                if ($elem.hasClass('row')) {
                    ...
                    if (clen && clen[1]) {
                        ...
                        new_table.closest('td[class*="table-row-"]').css({
                    ...
                    table.attr('width', '100%').css('width', '100%').find('td').attr({
                        'width': '100%',
                        'align': 'center'
                    }).css('width', '100%');
                    ...
                    if (($tag == 'div' || $tag == 'p') &&
                        ...
                        if ($tag == 'hr') {
                            $elem.attr('data-skipstyle', true);
                            element.css({
                                'background-color': $elem[0].style.backgroundColor || options['hr-background'],
                                'border-width': 0,
                                'height': '1px'
                            })
                        }
